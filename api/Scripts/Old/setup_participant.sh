...
echo "----------------------------"
echo ""
sudo adduser tracr --gecos "" --disabled-password
...
sudo apt-get install -y make build-essential libssl-dev zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev wget curl llvm libncurses5-dev libncursesw5-dev xz-utils tk-dev libffi-dev liblzma-dev python-openssl git bzip2 ncurses libffi
echo "Done."

echo ""
echo "----------------------------------"
echo "Installing uuid-runtime library..."
echo "----------------------------------"
echo ""
