...
from observer_rpc_node import ObserverService, ObserverRegistryServer
...
with open(
    utils.get_tracr_root() / "node_runner" / "rpc" / "test_dicts.yaml", "r"
) as file:
...
def create_servers():
    global reg
    reg = ObserverRegistryServer(allow_listing=True)
